...
fuzzer: fuzzer.cpp runner.cpp runner.h multi.cpp multi.h input.cpp input.h
	...
	$(CXX) -fsanitize-coverage=trace-pc-guard,indirect-calls,trace-cmp,trace-gep,trace-div,edge $(CXXFLAGS) fuzzer.o multi.o runner.o input.o libFuzzer.a modules/go/module.a modules/rust/module.a -lpthread -o fuzzer
clean:
	rm -rf *.o fuzzer
